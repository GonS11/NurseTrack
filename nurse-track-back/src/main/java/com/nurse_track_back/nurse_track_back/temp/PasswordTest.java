...
public class PasswordTest {
    public static void main(String[] args) {
        // Most of your existing hashes use a cost factor of 10.
        // If your application's BCryptPasswordEncoder is configured with a different
        // default,
        // adjust this value accordingly.
        BCryptPasswordEncoder encoderDefault = new BCryptPasswordEncoder(10);

        // For 'super_ana', you had a cost factor of 12.
        // If your application uses this consistently for certain roles or individually,
        // you would need an encoder with that factor.
        // For simplicity, we'll primarily use '10' unless specified.
        ...
        System.out.printf("User: %-15s | Plain: %-15s | Hash: %s%n", adminUsername, adminPassword, adminHashedPassword);
